...
export interface MultiSigAccessInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addApprover"
      | "approverCount"
...
export interface MultiSigAccess extends BaseContract {
  connect(runner?: ContractRunner | null): MultiSigAccess;
  waitForDeployment(): Promise<this>;

  interface: MultiSigAccessInterface;
