...
export declare namespace InsuranceAgentRecordManagement {
...
export interface InsuranceAgentRecordManagementInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeAgent"
      | "deauthorizeAgent"
...
export interface InsuranceAgentRecordManagement extends BaseContract {
  connect(runner?: ContractRunner | null): InsuranceAgentRecordManagement;
  waitForDeployment(): Promise<this>;

  interface: InsuranceAgentRecordManagementInterface;
  ...
  viewMyClaims: TypedContractMethod<
    [],
    [InsuranceAgentRecordManagement.InsuranceClaimStructOutput[]],
    "view"
  >;

  viewMyRecords: TypedContractMethod<
    [],
    [InsuranceAgentRecordManagement.HealthRecordStructOutput[]],
    "view"
  >;
