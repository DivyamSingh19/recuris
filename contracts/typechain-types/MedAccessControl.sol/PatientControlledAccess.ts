...
export declare namespace PatientControlledAccess {
...
export interface PatientControlledAccessInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "checkAccess"
      | "emergencyAccess"
...
export interface PatientControlledAccess extends BaseContract {
  connect(runner?: ContractRunner | null): PatientControlledAccess;
  waitForDeployment(): Promise<this>;

  interface: PatientControlledAccessInterface;
  ...
  getMyAccessHistory: TypedContractMethod<
    [count: BigNumberish],
    [PatientControlledAccess.AccessEventStructOutput[]],
    "view"
  >;

  getMyActivePermissions: TypedContractMethod<
    [],
    [PatientControlledAccess.AccessPermissionStructOutput[]],
    "view"
  >;
