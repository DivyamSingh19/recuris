...
export declare namespace DiagnosticCenterRecords {
...
export interface DiagnosticCenterRecordsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addDiagnosticReport"
...
export interface DiagnosticCenterRecords extends BaseContract {
  connect(runner?: ContractRunner | null): DiagnosticCenterRecords;
  waitForDeployment(): Promise<this>;

  interface: DiagnosticCenterRecordsInterface;
  ...
  viewMyReports: TypedContractMethod<
    [],
    [DiagnosticCenterRecords.DiagnosticReportStructOutput[]],
    "view"
  >;
